...
function isElement(node) {
    return node.nodeType === nodetype_1.NodeType.ELEMENT_NODE;
}
...
class HtmlElement extends domnode_1.DOMNode {
    ...
    get classList() {
        if (!this.hasAttribute("class")) {
            return new domtokenlist_1.DOMTokenList(null, null);
        }
        const classes = this.getAttribute("class", true)
            .filter((attr) => attr.isStatic)
            .map((attr) => attr.value)
            .join(" ");
        return new domtokenlist_1.DOMTokenList(classes, null);
    }
    /**
