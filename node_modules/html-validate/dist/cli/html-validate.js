...
function lint(files) {
    const reports = files.map((filename) => {
        try {
            ...
            console.error(kleur_1.default.red(`Validator crashed when parsing "${filename}"`));
            throw err;
        }
    });
...
function handleValidationError(err) {
    if (err.filename) {
        ...
        console.log(kleur_1.default.red(`A configuration error was found in "${filename}":`));
    }
    else {
        console.log(kleur_1.default.red(`A configuration error was found:`));
    }
    console.group();
    {
...
function handleUserError(err) {
    console.error(kleur_1.default.red("Caught exception:"));
    console.group();
    {
        console.error(err);
    }
...
function handleUnknownError(err) {
    ...
    console.error(kleur_1.default.red(`This is a bug in ${pkg.name}-${pkg.version}.`));
