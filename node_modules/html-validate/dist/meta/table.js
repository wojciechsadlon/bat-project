...
const ajvRegexpValidate = function (data, dataCxt) {
    ...
    if (!valid) {
        ajvRegexpValidate.errors = [
            {
                dataPath: dataCxt === null || dataCxt === void 0 ? void 0 : dataCxt.dataPath,
...
class MetaTable {
    ...
    loadFromObject(obj, filename = null) {
        ...
        if (!validate(obj)) {
            throw new error_1.SchemaValidationError(filename, `Element metadata is not valid`, obj, this.schema, 
    ...
    loadFromFile(filename) {
        try {
            ...
            const data = utils_1.requireUncached(filename);
