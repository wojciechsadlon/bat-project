...
class VoidStyle extends rule_1.Rule {
    ...
    shouldBeOmitted(node) {
        return this.style === Style.AlwaysOmit && node.closed === dom_1.NodeClosed.VoidSelfClosed;
    }
    shouldBeSelfClosed(node) {
        return this.style === Style.AlwaysSelfclose && node.closed === dom_1.NodeClosed.VoidOmitted;
    }
}
