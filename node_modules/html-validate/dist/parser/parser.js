...
class Parser {
    ...
    parseHtml(source) {
        ...
        while (!it.done) {
            ...
            switch (token.type) {
                case lexer_1.TokenType.UNICODE_BOM:
                    /* ignore */
                    break;
    ...
    consumeTag(source, startToken, tokenStream) {
        ...
        const isClosing = !isStartTag || node.closed !== dom_1.NodeClosed.Open;
    ...
    consumeAttribute(source, node, token, next) {
        ...
        if (next && haveValue) {
            attrData.value = (_a = next.data[1]) !== null && _a !== void 0 ? _a : null;
            attrData.quote = (_b = next.data[2]) !== null && _b !== void 0 ? _b : null;
        }
    ...
    getAttributeLocation(key, value) {
        ...
        const end = value && value.type === lexer_1.TokenType.ATTR_VALUE ? value.location : undefined;
        return {
